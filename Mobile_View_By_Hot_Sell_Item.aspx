<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Mobile_View_By_Hot_Sell_Item.aspx.cs" Inherits="Mobile_View_By_Hot_Sell_Item" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
      ...
      <div>
           <table style="width: 100%"> 
             ...
             <tr>
                        <td   bgcolor=#CCFFFF  width="1600px" height="800px">
                            ...
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2" GroupItemCount="1" >
                             ...
                             <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;
                                 ...
                                 SelectCommand="SELECT DISTINCT [商品描述], [商品售價], [商品庫存量], [商品名稱], [商品編號], [商品類別] FROM [資料表1] WHERE (商品庫存量) > 50">
                                 <SelectParameters>
