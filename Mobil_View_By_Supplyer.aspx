<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Mobil_View_By_Supplyer.aspx.cs" Inherits="Mobil_View_By_Supplyer" %>
             ...
             <tr>
                        <td valign="top" bgcolor="#FFFFCC"  style="width: 100%" height="40px">
                             ...
                             <asp:DropDownList ID="DropDownList_By_Type" runat="server" Height="40px" Width="200px" 
                                 valign ="top"  AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="商品廠商" DataValueField="商品廠商" Font-Size="Large">
                        ...
                        <td   bgcolor=#CCFFFF  style="width: 100%" height="800px">
                            ...
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2" GroupItemCount="1" >
                             ...
                             <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;
                                 ...
                                 SelectCommand="SELECT DISTINCT [商品描述], [商品售價], [商品庫存量], [商品名稱], [商品編號] FROM [資料表1] WHERE [商品廠商] = @商品廠商">
                                 <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList_By_Type" Name="商品廠商"  PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                             </asp:SqlDataSource> 
