            ...
            <tr>
                ...
                <td style="background-color: #CCFFFF" class="col-md-10">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;
                                 ...
                                 SelectCommand="SELECT DISTINCT [商品描述], [商品售價], [商品庫存量], [商品原價],[商品名稱], [商品編號] FROM [資料表1] WHERE [商品廠商] = @商品廠商">
                                 <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList_By_Supplyer" Name="商品廠商"  PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                             </asp:SqlDataSource> 
