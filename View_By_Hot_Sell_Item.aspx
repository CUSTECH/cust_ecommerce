<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="View_By_Hot_Sell_Item.aspx.cs" Inherits="View_By_Hot_Sell_Item" %>


<asp:Content ID="whowhat_View_By_Hot_Sell_Item" ContentPlaceHolderID="MainContent" Runat="Server">
            ...
            <tr>
                ...
                <td style="background-color: #CCFFFF" class="col-md-10">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Provider=Microsoft.ACE.OLEDB.12.0;
                        ...
                        SelectCommand="SELECT DISTINCT [商品描述], [商品售價], [商品庫存量], [商品名稱], [商品原價],[商品編號], [商品類別] FROM [資料表1] Where (商品庫存量) > 20">
                        <SelectParameters>
                        </SelectParameters>
                    </asp:SqlDataSource>
